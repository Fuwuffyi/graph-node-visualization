...
void RendererHelper::drawLine(SDL_Renderer *renderer, const glm::vec2 &start,
  ...
  SDL_SetRenderDrawColor(renderer, color.r, color.g, color.b, color.a);
  SDL_RenderDrawLineF(renderer, points[0].x, points[0].y, points[1].x,
                      points[1].y);
  SDL_RenderDrawLineF(renderer, points[1].x, points[1].y, points[2].x,
                      points[2].y);
  SDL_RenderDrawLineF(renderer, points[2].x, points[2].y, points[3].x,
                      points[3].y);
  SDL_RenderDrawLineF(renderer, points[3].x, points[3].y, points[0].x,
                      points[0].y);
}
